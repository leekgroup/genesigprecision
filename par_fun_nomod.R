#'
#' Parallelized Adjusted Estimator Simulation Function - No Modeling
#'
...
par_fun_nomod <- function(seed, rand=F){
	...
	while(i <= 100){
		...
		# Here, we supply the baseline covariates directly for adjustment
